...
![AWS EC2 Setup](screenshots/02-AWS-EC2-Instances.png)
...
![Jenkins Installation](screenshots/03-Jenkins-Server-EC2-Setup.png)
...
![Java Version Check](screenshots/04-Java-Version-Compatibility-Issue.png)

![Java Installation](screenshots/06-Java-Version-21-Installed.png)

![Updated Java Version](screenshots/07-Java-Version-Verification.png)

![ava-Version-Verification](screenshots/15-Updated-Java-Version-Verification.png)
...
![Jenkins Security Configuration](screenshots/05-Jenkins-Security-Group-Inbound-Rule.png)
...
![Jenkins Repository Setup](screenshots/12-Jenkins-Repository-Configuration.png)
...
![Jenkins Service Enabled](screenshots/09-Jenkins-Enabled-and-Running.png)
...
![Jenkins Welcome Page](screenshots/10-Welcome-to-Jenkins-on-btpwser.png)

![Jenkins Web Interface](screenshots/11-Jenkins-Web-Interfac.png)
